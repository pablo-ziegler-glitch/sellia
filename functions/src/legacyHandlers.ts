...
import {
  createCollectUsageMetricsHandler,
  createEvaluateTenantBudgetAlertsHandler,
  createEvaluateUsageAlertsHandler,
  createGetTenantCostDashboardHandler,
  createGetUsageMetricsHistoryHandler,
  sanitizeAlertId,
  summarizeError,
...
export const getUsageMetricsHistory = functions
  .runWith({ enforceAppCheck: true })
  .https.onCall((data, context) =>
    createGetUsageMetricsHistoryHandler({ db, normalizeString, sanitizePiiForLog })(data, context)
  );
...
export const syncPublicProductOnWrite = functions.firestore
  ...
  .onWrite(createSyncPublicProductOnWriteHandler(db));
...
export const getTenantCostDashboard = functions
  .runWith({ enforceAppCheck: true })
  .https.onCall(createGetTenantCostDashboardHandler(db, normalizeString));
