...
import com.floki.app.data.model.usage.UsageSeriesPoint
import com.floki.app.data.model.usage.UsageServiceSummary
import com.floki.app.data.remote.UsageFirestoreSchema
import com.floki.app.data.remote.UsageSnapshotDocument
...
private fun UsageSnapshotDocument.toDomain(
    ...
    return FirebaseServiceUsage(
        ...
        serviceId = serviceId,
        scope = resolvedScope,
        snapshot = com.floki.app.domain.usage.UsageSnapshot(
            periodId = periodId,
