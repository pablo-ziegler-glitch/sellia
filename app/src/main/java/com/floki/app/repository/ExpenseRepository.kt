...
import com.floki.app.data.csv.ExpenseCsvImporter
import com.floki.app.data.model.CashflowMonth
import com.floki.app.data.model.ExpenseCategoryBudget
import com.floki.app.data.model.ExpenseCategoryComparison
import com.floki.app.data.model.ExpenseRecord
import com.floki.app.data.model.ExpenseStatus
import com.floki.app.data.model.ExpenseTemplate
import com.floki.app.data.model.ProviderInvoiceStatus
...
class ExpenseRepository @Inject constructor(
    ...
    suspend fun importRecordsFromTable(table: List<List<String>>): com.floki.app.data.model.ImportResult {
        val rows = ExpenseCsvImporter.parseTable(table)
        if (rows.isEmpty()) {
            return com.floki.app.data.model.ImportResult(0, 0, listOf("El archivo no contiene filas válidas."))
        }
        var inserted = 0
        ...
        return com.floki.app.data.model.ImportResult(inserted, 0, errors)
    }
