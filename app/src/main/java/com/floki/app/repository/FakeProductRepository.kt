...
class FakeProductRepository : IProductRepository {
    ...
    override fun observeStockMovements(productId: Int, limit: Int): Flow<List<com.floki.app.data.model.stock.StockMovementWithProduct>> =
        flowOf(emptyList())

    override fun observeRecentStockMovements(limit: Int): Flow<List<com.floki.app.data.model.stock.StockMovementWithProduct>> =
        flowOf(emptyList())
