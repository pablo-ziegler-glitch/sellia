...
import com.floki.app.data.local.entity.SyncEntityType
import com.floki.app.data.local.entity.SyncOutboxEntity
import com.floki.app.data.local.entity.TenantSkuConfigEntity
import com.floki.app.data.mappers.toModel
import com.floki.app.data.model.ImportResult
import com.floki.app.data.model.Product
import com.floki.app.data.model.dashboard.LowStockProduct
import com.floki.app.data.model.stock.StockAdjustmentReason
import com.floki.app.data.model.stock.StockMovementReasons
import com.floki.app.data.model.stock.StockMovementWithProduct
import com.floki.app.auth.TenantProvider
import com.floki.app.data.remote.CrossCatalogAuditContext
import com.floki.app.data.remote.CrossCatalogRemoteDataSource
import com.floki.app.data.remote.InvalidCrossCatalogDataException
import com.floki.app.data.remote.ProductRemoteDataSource
import com.floki.app.data.remote.StockInteractionEvent
import com.floki.app.data.remote.StockInteractionRemoteDataSource
import com.floki.app.di.IoDispatcher
import com.floki.app.pricing.PricingCalculator
import com.floki.app.sync.CsvImportWorker
...
class ProductRepository(
    ...
    suspend fun ensureCategoryId(name: String?): Int? {
        ...
        val id = categoryDao.insert(com.floki.app.data.local.entity.CategoryEntity(name = n))
    ...
    suspend fun ensureProviderId(name: String?): Int? {
        ...
        if (existing != null) return existing.id
        val id = providerDao.insert(com.floki.app.data.local.entity.ProviderEntity(name = n))
    ...
    private suspend fun syncDownIncremental(
        remoteList: List<com.floki.app.data.remote.ProductFirestoreMappers.RemoteProduct>
    ): Int {
        var applied = 0
        db.withTransaction {
