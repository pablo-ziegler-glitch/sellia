...
import com.floki.app.data.AppDatabase
import com.floki.app.data.dao.CategoryDao
import com.floki.app.data.dao.CashAuditDao
import com.floki.app.data.dao.CashMovementDao
import com.floki.app.data.dao.CashSessionDao
import com.floki.app.data.dao.CloudServiceConfigDao
import com.floki.app.data.dao.DevelopmentOptionsDao
import com.floki.app.data.dao.CustomerDao
import com.floki.app.data.dao.ExpenseBudgetDao
import com.floki.app.data.dao.ExpenseRecordDao
import com.floki.app.data.dao.ExpenseTemplateDao
import com.floki.app.data.dao.InvoiceDao
import com.floki.app.data.dao.InvoiceItemDao
import com.floki.app.data.dao.ProductDao
import com.floki.app.data.dao.ProductPriceAuditDao
import com.floki.app.data.dao.ProductImageDao
import com.floki.app.data.dao.ProviderDao
import com.floki.app.data.dao.ProviderInvoiceDao
import com.floki.app.data.dao.PricingAuditDao
import com.floki.app.data.dao.PricingFixedCostDao
import com.floki.app.data.dao.PricingMlFixedCostTierDao
import com.floki.app.data.dao.PricingMlShippingTierDao
import com.floki.app.data.dao.PricingSettingsDao
import com.floki.app.auth.FirebaseSessionCoordinator
import com.floki.app.auth.TenantProvider
import com.floki.app.data.dao.ReportDataDao
import com.floki.app.data.dao.SyncOutboxDao
import com.floki.app.data.dao.TenantSkuConfigDao
import com.floki.app.data.dao.UserDao
import com.floki.app.data.dao.VariantDao
import com.floki.app.repository.CloudServiceConfigRepository
import com.floki.app.repository.CustomerRepository
import com.floki.app.repository.AccessControlRepository
import com.floki.app.repository.AccountRequestsRepository
import com.floki.app.repository.AuthOnboardingRepository
import com.floki.app.repository.CashRepository
import com.floki.app.repository.DevelopmentOptionsRepository
import com.floki.app.repository.ExpenseRepository
import com.floki.app.repository.MarketingConfigRepository
import com.floki.app.repository.PricingConfigRepository
import com.floki.app.repository.ProductRepository
import com.floki.app.repository.ReportsRepository
import com.floki.app.repository.SecurityConfigRepository
import com.floki.app.repository.StorageRepository
import com.floki.app.repository.TenantDirectoryRepository
import com.floki.app.repository.TenantManagementRepository
import com.floki.app.repository.TenantOwnershipRepository
import com.floki.app.repository.UsageRepository
import com.floki.app.repository.UserRepository
import com.floki.app.repository.ViewerStoreRepository
import com.floki.app.repository.impl.AccountRequestsRepositoryImpl
import com.floki.app.repository.impl.AccessControlRepositoryImpl
import com.floki.app.repository.impl.AuthOnboardingRepositoryImpl
import com.floki.app.repository.impl.CashRepositoryImpl
import com.floki.app.repository.impl.TenantDirectoryRepositoryImpl
import com.floki.app.repository.impl.TenantManagementRepositoryImpl
import com.floki.app.repository.impl.TenantOwnershipRepositoryImpl
import com.floki.app.repository.impl.StorageRepositoryImpl
import com.floki.app.repository.impl.UsageRepositoryImpl
import com.floki.app.repository.impl.ViewerStoreRepositoryImpl
