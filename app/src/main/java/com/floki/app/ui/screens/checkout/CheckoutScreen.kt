package com.floki.app.ui.screens.checkout
...
import com.floki.app.ui.navigation.Routes
import com.floki.app.ui.navigation.Routes.SellRoutes.SELL_FLOW_ROUTE
import com.floki.app.ui.state.CustomerSummaryUi
import com.floki.app.ui.state.OrderType
import com.floki.app.ui.state.PaymentMethod
import com.floki.app.viewmodel.CustomersViewModel
import com.floki.app.viewmodel.SellViewModel
import com.floki.app.viewmodel.checkout.CheckoutViewModel
...
private fun CustomerValidationDialog(
    customers: List<com.floki.app.data.local.entity.CustomerEntity>,
    onDismiss: () -> Unit,
    onPickExisting: (com.floki.app.data.local.entity.CustomerEntity) -> Unit,
