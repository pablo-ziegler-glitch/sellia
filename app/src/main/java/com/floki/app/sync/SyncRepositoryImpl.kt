...
import com.floki.app.data.remote.InvoiceFirestoreMappers
import com.floki.app.data.remote.CustomerFirestoreMappers
import com.floki.app.data.remote.ProductFirestoreMappers
import com.floki.app.di.AppModule.IoDispatcher // [NUEVO] El qualifier real del ZIP está dentro de AppModule
...
class SyncRepositoryImpl @Inject constructor(
    ...
    */
    ...
    private fun DocumentSnapshot.toCustomerEntityOrNull() = runCatching {
        ...
        com.floki.app.data.local.entity.CustomerEntity(
            id = idValue,
            name = name,
