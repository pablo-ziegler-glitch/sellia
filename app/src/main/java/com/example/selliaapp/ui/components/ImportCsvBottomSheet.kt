...
fun ImportCsvBottomSheet(
    ...
    val template = remember {
        buildAnnotatedString {
            ...
            appendLine("code,barcode,name,quantity,purchase_price,price,list_price,cash_price,transfer_price,transfer_net_price,ml_price,ml_3c_price,ml_6c_price,category,min_stock")
