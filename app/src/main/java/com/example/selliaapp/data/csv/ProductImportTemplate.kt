        ...
        return buildString {
            ...
            appendLine(
                "Shampoo 500ml,1800.00,24,Perfumería,Higiene,Shampoo para uso diario,https://example.com/shampoo.jpg," +
                    "https://example.com/shampoo-2.jpg,SKU-001,7791234567890,Proveedor Demo,Marca Demo,,,PROV-SKU-001,5,X,,,,,,,,2024-01-15"
            )
            appendLine(
            ...
            appendLine(
                "Campera Kids,9000.00,8,Indumentaria,Abrigos,Campera térmica infantil,https://example.com/campera.jpg,," +
                    "SKU-003,7790000000003,Proveedor Demo,Marca Kids,Azul,6|8|10,PROV-SKU-003,2,X,11999,9999,10999,,,,,2024-01-15"
            )
        }
    }
