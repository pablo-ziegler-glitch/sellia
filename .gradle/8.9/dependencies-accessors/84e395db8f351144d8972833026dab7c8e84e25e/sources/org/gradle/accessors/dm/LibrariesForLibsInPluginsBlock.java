...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
     ...
     */
    @Deprecated
    public static class AndroidxRoomCommonLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>room.common.jvm</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class AndroidxTestVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.test.core</b> with value <b>1.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidx.test.runner</b> with value <b>1.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxTestEspressoVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.test.espresso.core</b> with value <b>3.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ApacheVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>apache.poi</b> with value <b>5.2.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinxCoroutinesVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinx.coroutines.test</b> with value <b>1.8.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class RoomVersionAccessors extends VersionFactory  {
        ...
        private final RoomCommonVersionAccessors vaccForRoomCommonVersionAccessors = new RoomCommonVersionAccessors(providers, config);
        public RoomVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.room.common</b>
         */
        public RoomCommonVersionAccessors getCommon() {
            return vaccForRoomCommonVersionAccessors;
        }

    }

    public static class RoomCommonVersionAccessors extends VersionFactory  {

        public RoomCommonVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>room.common.jvm</b> with value <b>2.8.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJvm() { return getVersion("room.common.jvm"); }
    ...
    public static class RuntimeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>runtime.livedata</b> with value <b>1.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
